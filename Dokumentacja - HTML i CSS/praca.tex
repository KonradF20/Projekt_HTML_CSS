...
\author{Konrad Fugiel}
\shortauthor{K. Fugiel}
\noAlbum{134909}

\titlePL{Dokumentacja do strony internetowej - Kroniki Hogwartu}

\shorttitlePL{Dokumentacja do strony internetowej - Kroniki Hogwartu} % skrócona wersja tytułu jeśli jest bardzo długi

\thesistype{Praca projektowa}


\thesisDone{Praca wykonana pod kierunkiem}
\supervisor{dr Katarzyna Garwol}
